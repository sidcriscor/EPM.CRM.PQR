...
{
    public partial class CerrarMensaje
    {
        /// <summary>
        ...
        public void Mouse_Click_ButBegin(RepoItemInfo buttontagInfo)
        {
//            Validate.Exists(repo.SaveDialog.ButtonOKInfo);
//            if(Validate.NotExists(repo.SaveDialog.ButtonOKInfo)){
//            	
//            }
//            
//            
//            
////            if (buttontagInfo.Exists() ) {
